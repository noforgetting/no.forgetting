...
window.addEventListener("noforgetting:data-changed", () => { appData = loadData(); renderProgress(false); });
let timerSeconds = 0;
...
function renderProgress(persist = true) {
  updateStreak(appData);
  if (persist) saveData(appData);
