...
window.addEventListener("noforgetting:data-changed", () => { Object.assign(data, loadData()); render(); });
...
function widget(targetId, items, title, detail, collection) {
  ...
  target.innerHTML = items.length
    ...
    : `<div class="empty-state">All done. You can undo completion in each reminders pages</div>`;
